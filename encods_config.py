...
## general settings.
parser.add_argument('--train_data_root', type=str, default='workbitch/work_enco_pggan/data')
parser.add_argument('--csv_file', type=str, default='workbitch/work_enco_pggan/encods_1.csv') #csv file which stores all encodings
...
parser.add_argument('--nz', type=int, default=128)              # input dimension of noise.
